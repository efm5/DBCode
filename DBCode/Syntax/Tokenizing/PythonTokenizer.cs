namespace DBCode.Syntax.Tokenizing {
   internal sealed class PythonTokenizer : ITokenizer {
      private readonly List<ITokenReader> mReaders;

      internal PythonTokenizer(ILanguageDefinition pDefinition) {
         mReaders = [
            new WhitespaceReader(),
            new PythonCommentReader(),
            new PythonStringReader(),
            new NumberReader(),
      ...
      public LanguageKind Language {
         get { return LanguageKind.Python; }
      }
