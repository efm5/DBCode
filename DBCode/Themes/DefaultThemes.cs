...
namespace DBCode.Themes {
   public static class ThemeBuiltIns {
      public static Theme CreateLightTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = ColorTranslator.FromHtml("#F3F3F3");
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = ColorTranslator.FromHtml("#1E1E1E");
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = ColorTranslator.FromHtml("#1E1E1E");
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = ColorTranslator.FromHtml("#444444");
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = ColorTranslator.FromHtml("#1E1E1E");
      ...
      public static Theme CreateDarkTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = ColorTranslator.FromHtml("#252526");
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = ColorTranslator.FromHtml("#D4D4D4");
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = ColorTranslator.FromHtml("#1E1E1E");
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = ColorTranslator.FromHtml("#D4D4D4");
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = ColorTranslator.FromHtml("#9B9B9B");
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = ColorTranslator.FromHtml("#3C3C3C"); // Charcoal gray
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = ColorTranslator.FromHtml("#89C2D9"); // Soft blue
      ...
      public static Theme CreateClassicTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = SystemColors.Control;
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = SystemColors.ControlText;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = SystemColors.Control;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = SystemColors.ControlText;
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = SystemColors.ControlText;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = SystemColors.Window;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = SystemColors.WindowText;
      ...
      public static Theme CreateHighContrastLightTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = Color.Black;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = Color.Black;
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = Color.Black;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = Color.Black;
      ...
      public static Theme CreateHighContrastDarkTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = Color.Black;
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = Color.Black;
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = Color.White;
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = Color.White;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = Color.Black;
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = Color.White;
      ...
      public static Theme CreateLightPastelTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = ColorTranslator.FromHtml("#E8E6F2");   // lavender-gray
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = ColorTranslator.FromHtml("#3A3A3A");         // charcoal
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = ColorTranslator.FromHtml("#F5F7FA");  // fog-white
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = ColorTranslator.FromHtml("#3A3A3A");        // charcoal
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = ColorTranslator.FromHtml("#6A6A6A"); // dark gray
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = ColorTranslator.FromHtml("#FFFFF0");              // very light yellow
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = ColorTranslator.FromHtml("#2E86C1");          // pastel blue
      ...
      public static Theme CreateDarkPastelTheme(bool pAdd = true) {
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxBackground] = ColorTranslator.FromHtml("#2D2B3A");   // dark lavender-gray
         theme.mInterfaceColors[(int)ColorSwatchUsage.GroupBoxFont] = ColorTranslator.FromHtml("#C8C4D8");         // light lavender
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceBackground] = ColorTranslator.FromHtml("#1F1D2B");  // deep purple-black
         theme.mInterfaceColors[(int)ColorSwatchUsage.InterfaceFont] = ColorTranslator.FromHtml("#D4D0E0");        // soft white-lavender
         ...
         theme.mInterfaceColors[(int)ColorSwatchUsage.TabHeaderUnselectedFont] = ColorTranslator.FromHtml("#8A8A9A"); // muted gray
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBox] = ColorTranslator.FromHtml("#2B2838");              // dark purple-gray
         theme.mInterfaceColors[(int)ColorSwatchUsage.TextBoxFont] = ColorTranslator.FromHtml("#C9BDD8");          // soft lavender
